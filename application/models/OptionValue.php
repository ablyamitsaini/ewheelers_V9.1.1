...
class OptionValue extends MyAppModel{
	...
	public function getOptionValue($optionId){
		...
		if(!empty($record)){
			$lang_record = CommonHelper::getLangFields($record['optionvalue_id'],
		'optionvaluelang_optionvalue_id','optionvaluelang_lang_id',array('optionvalue_name'),static::DB_TBL.'_lang');
