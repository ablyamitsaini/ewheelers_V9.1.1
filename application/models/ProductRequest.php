...
class ProductRequest extends MyAppModel{
	...
	static function getStatusArr($langId){
	...
	public static function getProductShippingRates($preq_id, $lang_id, $country_id = 0, $sellerId = 0, $limit = 0){
		...
		if(!empty($shippingArr)){
			...
			foreach($shippingArr  as $val) {
				...
				$shipCompSrch = ShippingCompanies::getListingObj($lang_id,array('ifNull('.ShippingCompanies::DB_TBL_PREFIX.'name',ShippingCompanies::DB_TBL_PREFIX.'identifier) as '.ShippingCompanies::DB_TBL_PREFIX.'name',
				...
				$shipDurationSrch = ShippingDurations::getListingObj($lang_id,array(ShippingDurations::DB_TBL_PREFIX.'name',
