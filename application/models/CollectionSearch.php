...
class CollectionSearch extends SearchBase {
	...
	public function __construct( $langId = 0 ) {
		...
		if ( $this->langId > 0) {
			$this->joinTable( Collections::DB_TBL_LANG,'LEFT OUTER JOIN',
	...
	public function joinCollectionProducts(){
		...
		$this->joinTable( Collections::DB_TBL_COLLECTION_TO_SELPROD,'LEFT OUTER JOIN',
	...
	public function joinSellerProductsForPrice($langId = 0, $forDate = ''){
		...
		$this->joinTable( SellerProduct::DB_TBL_SELLER_PROD_SPCL_PRICE, 'LEFT OUTER JOIN',
