...
class BannerLocation extends MyAppModel
{
    ...
    public static function getPromotionalBanners($blocationId, $langId, $pageSize = 0)
    {
        ...
        foreach ($bannerLocation as $val) {
            ...
            $bsrch->joinBudget();
            $bsrch->addMultipleFields(array('banner_id','banner_blocation_id','banner_type','banner_record_id', 'banner_url_type','banner_url','banner_target','banner_title','promotion_id','daily_cost','weekly_cost','monthly_cost','total_cost','banner_img_updated_on'));
            ...
            $srch->addMultipleFields(array('banner_id','banner_blocation_id','banner_type','banner_record_id','banner_url_type','banner_url','banner_target','banner_title','promotion_id','userBalance','daily_cost','weekly_cost','monthly_cost','total_cost','promotion_budget','promotion_duration','banner_img_updated_on'));
            if ($pageSize == 0) {
