...
class ShippingApi extends MyAppModel {
	...
	public static function getShippingPrice( $data = array() , $langId = 0 , &$msg ){
		...
		$srch->joinTable( ManualShippingApi::DB_TBL_LANG, 'LEFT OUTER JOIN',
		'msapi_l.mshipapilang_mshipapi_id = msapi.mshipapi_id AND msapi_l.mshipapilang_lang_id = ' . $langId,'msapi_l');
