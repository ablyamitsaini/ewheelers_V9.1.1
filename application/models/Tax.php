...
class Tax extends MyAppModel{
	...
	public static function getTaxCatObjByProductId($productId,$langId = 0){
		...
		$srch->joinTable(static::DB_TBL_VALUES, 'LEFT OUTER JOIN',
		'tv.taxval_taxcat_id = t.taxcat_id','tv');
		$srch->joinTable(static::DB_TBL_PRODUCT_TO_TAX, 'LEFT OUTER JOIN',
		'ptt.ptt_taxcat_id = t.taxcat_id','ptt');
	...
	static public function getTaxCatByProductId($productId =0 ,$userId = 0,$langId = 0,$fields=array()){
		$taxData =  array();
