...
class ShippingDurations extends MyAppModel
{
    ...
    public static function getSearchObject($langId = 0, $isDeleted = true) 
    {
        ...
        if($langId > 0) {
            $srch->joinTable(
                ...
                'sd_l.sdurationlang_sduration_id = sd.sduration_id AND sd_l.sdurationlang_lang_id = ' . $langId, 'sd_l'
            );
        }        
        return $srch;
    }
    ...
    static function getShippingDurationTitle($sdurationRow, $siteLangId)
    {
