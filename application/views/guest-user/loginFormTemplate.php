...
<div id="sign-in" >
	<div class="login-wrapper">
	  ...
	  <div class="add-side">
		...
		<div class="connect group--social-onehalf">
	...
	V14.141h3.969l0.609-4.625H8.766V6.563c0-1.328,0.359-2.25,2.281-2.25H13.5V0.188z"/>
		...
		<?php } if ($googleLogin ) { ?>
			...
			<a href="<?php echo CommonHelper::generateUrl('GuestUser', 'socialMediaLogin',array('google')); ?>" class="link gp">
				<i class="svg">
				...
				</i> <?php echo Labels::getLabel('LBL_Login_With_Google',$siteLangId);?>
			</a>
		<?php } ?> </div>
	  </div>
	  <?php } ?>
