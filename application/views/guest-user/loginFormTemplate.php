...
<div id="sign-in">
	<div class="login-wrapper">
	  <div class="form-side">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12"> <a class="btn btn--third btn--block" href="<?php echo CommonHelper::generateUrl('GuestUser', 'loginForm', array(applicationConstants::YES)); ?>"><?php echo sprintf(Labels::getLabel('LBL_Not_Register_Yet?',$siteLangId),FatApp::getConfig('CONF_WEBSITE_NAME_'.$siteLangId));?></a> </div>
		</div>
		<?php } ?>
