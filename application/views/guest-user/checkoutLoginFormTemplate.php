...
<form name="formLoginPage" method="post" id="formLoginPage" class="form" onsubmit="return setUpLogin(this, loginFormObj);">

<div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="field-set"><div class="caption-wraper"><label class="field_label">Username Or Email<span class="spn_must_field">*</span></label></div><div class="field-wraper"><div class="field_cover"><input placeholder="Email Address" data-field-caption="Username Or Email" data-fatreq="{&quot;required&quot;:true}" name="username" value="" type="text"></div></div></div></div></div><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="field-set"><div class="caption-wraper"><label class="field_label">Password<span class="spn_must_field">*</span></label></div><div class="field-wraper"><div class="field_cover"><input placeholder="Password" data-field-caption="Password" data-fatreq="{&quot;required&quot;:true}" name="password" value="" type="password"></div></div></div></div></div><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> </div></div><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="field-set"><div class="caption-wraper"><label class="field_label"></label></div><div class="field-wraper"><div class="field_cover"><input class="btn--block" data-field-caption="" data-fatreq="{&quot;required&quot;:false}" name="btn_submit" value="Login" type="submit"></div></div></div></div></div></form>
</div>
	<?php
	...
	$googleLogin  =(FatApp::getConfig('CONF_ENABLE_GOOGLE_LOGIN', FatUtility::VAR_INT , 0)&& FatApp::getConfig('CONF_GOOGLEPLUS_CLIENT_ID', FatUtility::VAR_STRING , ''))?true:false ; if ($facebookLogin || $googleLogin ){?>
		...
		<div class="row">
			<div class=" col-lg-12 add-side">
				<div class="or"><?php echo Labels::getLabel('LBL_Or', $siteLangId); ?></div>
				<div class="connect">
