							...
							<?php $count = 1; foreach($row['categories'] as $category) { ?>
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
									<div class="top-categories">
										<div class="cat-img"><img data-ratio="16:9" src="<?php echo FatCache::getCachedUrl(CommonHelper::generateUrl('Category', 'banner', array($category['prodcat_id'] , $siteLangId, 'MEDIUM')), CONF_IMG_CACHE_TIME, '.jpg'); ?>" alt= "<?php echo $category['prodcat_name']; ?> " title= "<?php echo $category['prodcat_name']; ?> "></div>
