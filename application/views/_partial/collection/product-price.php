	...
	<div class="products__price"><?php echo CommonHelper::displayMoneyFormat($product['rent_price']); ?>
		 <?php echo $rentalTypeArr[$product['rental_type']];?>
    </div>
	<?php }?>
	<?php if (ALLOW_SALE > 0 && $product['is_sell'] > 0 ) { ?>
	<div class="products__price"><?php echo CommonHelper::displayMoneyFormat($product['theprice']); ?>  <?php echo Labels::getLabel('LBL_Retail', $siteLangId);?></span>
