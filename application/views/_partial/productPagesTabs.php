<div class="tabs tabs--small tabs--offset tabs--scroll clearfix setactive-js">
	<ul>
		<li class="<?php echo ($controllerName == 'seller' && $action == 'catalog') ? 'is-active' : $action; ?>"><a href="<?php echo CommonHelper::generateUrl('seller','catalog');?>"><?php echo Labels::getLabel('LBL_Marketplace_Products',$siteLangId); ?></a></li>
