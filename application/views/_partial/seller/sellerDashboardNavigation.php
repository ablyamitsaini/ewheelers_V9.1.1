...
?> <div class="sidebar no-print">
    ...
    <div class="sidebar__content custom-scrollbar" data-simplebar>
        <nav class="dashboard-menu">
            <ul>
                <li class="menu__item <?php echo ($controller == 'seller' && $action == 'index') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo Labels::getLabel('LBL_Dashboard', $siteLangId);?>" href="<?php echo CommonHelper::generateUrl('Seller'); ?>">
                ...
                </li> <?php if ($isShopActive && $shop_id > 0) {
            ?>
