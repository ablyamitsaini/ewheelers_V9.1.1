	...
	<div class="box box--white box--space">
		...
		<div class="box box--list">
			...
			<ul class="links--vertical">
				...
				<!--<li class="<?php /* echo ($controller == 'account' && $action == 'savedsearches') ? 'is-active' : ''; ?>"><a href="<?php echo CommonHelper::generateUrl('Account','savedSearches');?>"><i class="fa fa-search-plus"></i><?php echo Labels::getLabel('LBL_Saved_Searches',$siteLangId); */?></a></li>-->
