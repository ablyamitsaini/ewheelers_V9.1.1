...
?> <div class="sidebar no-print">
    ...
    <div class="sidebar__content custom-scrollbar" data-simplebar>
        <nav class="dashboard-menu">
            ...
            ?>
            <li class="menu__item <?php echo ($controller == 'affiliate' && $action == 'index') ? 'is-active' : ''; ?>">
                <div class="menu__item__inner">
                    <a title="<?php echo Labels::getLabel('LBL_Dashboard', $siteLangId);?>" href="<?php echo CommonHelper::generateUrl('affiliate'); ?>">
