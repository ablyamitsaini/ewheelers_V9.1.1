		...
		<nav class="dashboard-menu">
			<ul>
				<?php if(User::canViewAffiliateTab()) { ?>
					<li class="menu__item <?php echo ($controller == 'affiliate' && $action == 'referredbyme  ') ? 'is-active' : ''; ?>"><div class="menu__item__inner"><a title="<?php echo Labels::getLabel("LBL_Sharing",$siteLangId); ?>" href="<?php echo CommonHelper::generateUrl('Affiliate','ReferredByMe'); ?>">
					<i class="icn shop"><svg class="svg"><use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#dash-reffered" href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#dash-reffered"></use></svg>
					</i><span class="menu-item__title"><?php echo Labels::getLabel("LBL_My_Referral",$siteLangId); ?></span></a></div></li>
				<?php } ?>
