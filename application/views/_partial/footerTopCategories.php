...
<?php if($topCategories){ ?>
	 <div class="accordion_triger"><?php echo Labels::getLabel('LBL_Top_Categories', $siteLangId); ?><span></span></div>
	  <div class="accordion_content">
			...
			<li><a href="<?php echo CommonHelper::generateUrl('Category', 'view', array($category['prodcat_id'])); ?>"><?php echo $category['prodcat_name'];?></a><?php /* echo ( count($topCategories) != $counter ) ? ',': ''; */ ?>
			</li>
			<?php $counter++; } ?>
