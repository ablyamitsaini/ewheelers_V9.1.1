		  ...
		  <?php foreach( $row['products'] as $product ){ ?>
              ...
              <div class="item-yk <?php if($product['selprod_stock']<=0){?> item--sold  <?php }?>">
                <div class="item__head">
                  <div class="item__lable"><?php echo Product::getConditionArr($siteLangId)[$product['selprod_condition']];?></div>
                  <div class="item__category"><a href="javascript:void(0)"><?php echo $product['selprod_title'];?> </a></div>
                  <div class="item__title"><a title="<?php echo $product['product_name'];?>" href="<?php echo CommonHelper::generateUrl('Products','View',array($product['selprod_id']));?>"><?php echo $product['product_name']; ?></a></div>
