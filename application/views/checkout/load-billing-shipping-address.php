...
<?php  if(isset($defaultAddress) && $defaultAddress) {
	...
	<div class="selected-panel" id="addressDivFooter">
		<?php if($hasPhysicalProduct){ ?>
		  <div class="selected-panel-type">2. <?php echo Labels::getLabel('LBL_Billing/Delivery_Address', $siteLangId)?></div>
		<?php }else{
			
		?>
		<div class="selected-panel-type">2. <?php echo Labels::getLabel('LBL_Billing_Address', $siteLangId)?></div>
		<?php } ?>
