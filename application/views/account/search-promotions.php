		...
		foreach ($arr_flds as $key=>$val){
			...
			switch ($key){
				...
				case 'promotion_clicks':
					$td->appendElement('a', array( 'title'=>Labels::getLabel('LBL_Enable', $siteLangId),
					'title'=>Labels::getLabel('LBL_Edit',$siteLangId),"href"=>CommonHelper::generateUrl('account', 'promotion_clicks', array($row['promotion_id']))),
					$row["totClicks"], true);
				break;
