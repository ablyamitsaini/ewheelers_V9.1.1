		 ...
		 <div class="container--addresses">
			 <div class="row">
				<?php if(!empty($addresses)){
					if( count( $addresses) == 1 && $addresses[0]['ua_is_default'] != 1 ){ $addresses[0]['ua_is_default'] = 1; }
					foreach( $addresses as $address ){
						$address['ua_identifier'] = ( $address['ua_identifier'] == '' ) ? '&nbsp;' : $address['ua_identifier'];
				?>
