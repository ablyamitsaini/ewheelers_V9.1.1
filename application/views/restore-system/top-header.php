<div class="demo-header no-print">
    ...
    <ul class="switch-interface">
        ...
        <li class="is-active"><a href="javascript:void(0)" onClick="setDemoLayout(360)"><i class="icn icn--desktop">
                    <svg class="svg">
         ...
         <li><a href="javascript:void(0);" onClick=""><i class="icn icn--tab">
                    <svg class="svg">
                        <use xlink:href="<?php echo CONF_WEBROOT_FRONTEND; ?>images/retina/sprite.svg#tab" href="<?php echo CONF_WEBROOT_FRONTEND; ?>images/retina/sprite.svg#tab"></use>
                    </svg>
                </i></a></li>
