<?php defined('SYSTEM_INIT') or die('Invalid Usage.');
 ...
 <div class="selected-panel">
	  <div class="selected-panel-type">1.  <?php echo Labels::getLabel('LBL_Review_Subscription_Details', $siteLangId);?></div>
	 ...
	 <div class="selected-panel-action"><a href="javascript:void(0)" class="btn btn--primary ripplelink reviewOrder"><?php echo Labels::getLabel('LBL_Review_Subscription_Details', $siteLangId);?></a></div>
	</div>
