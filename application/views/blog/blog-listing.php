...
<section class="section">
    <div class="container">
        <?php if($innerListcount==1) { ?><p class="results-message"><?php echo Labels::getLabel('LBL_Displaying', $siteLangId); ?> <span id="start_record"></span>-<span id="end_record"></span> <?php echo Labels::getLabel('LBL_of', $siteLangId); ?>
            <span id="total_records"></span></p>
        <?php } ?>
        <div class="post-list">
            <article class="post-repeated <?php echo ($innerListcount%2==0) ? "odd" : ""; ?>">
                <div class="posted-media">
                    <div class="posted-media-inner"><a href="<?php echo CommonHelper::generateUrl('Blog','postDetail',array($blogPost['post_id'])); ?>"><img
                                src="<?php echo CommonHelper::generateUrl('image','blogPostFront', array($blogPost['post_id'],$siteLangId, "BANNER"),CONF_WEBROOT_URL); ?>" alt="<?php echo $blogPost['post_title']?>"></a></div>
                </div>
                <div class="posted-data-side">
                    <div class="posted-data">
                        <div class="posted-by"><span class="auther"><?php echo Labels::getLabel('Lbl_By',$siteLangId)." "; ?> <?php echo CommonHelper::displayName($blogPost['post_author_name']); ?></span> <span
                                class="time"><?php echo FatDate::format($blogPost['post_published_on']); ?></span></div>
