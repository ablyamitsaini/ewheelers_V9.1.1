...
<div class="comment box box--white  p-4">
    ...
    <?php } else {
    echo Labels::getLabel('Msg_No_Comments_on_this_blog_post', $siteLangId); ?>
    <!--<a href="javascript:undefined" class="link--post-comment-form" ><?php // echo Labels::getLabel('Lbl_Submit_your_comment',$siteLangId);?></a>-->
    <?php
} ?>
</div>
<?php
