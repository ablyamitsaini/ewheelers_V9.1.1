 ...
 <div class="content-wrapper content-space">
	<div class="content-header justify-content-between row mb-3">
		<div class="content-header-left col-auto ">
			...
			<h2 class="content-header-title"><?php echo Labels::getLabel('LBL_My_Offers', $siteLangId); ?></h2>
		</div>
	</div>
	<div class="content-body">
		<div class="cards">
			<div class="cards-header">
				<h5 class="cards-title p-3"><?php echo Labels::getLabel('LBL_My_Offers', $siteLangId); ?></h5>
			</div>
