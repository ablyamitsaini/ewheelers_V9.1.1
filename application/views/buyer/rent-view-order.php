            ...
            <div class="col-md-auto">
                ...
                <?php if (!$print) { ?>
                    <ul class="actions no-print">
                        ...
                        <li>
                            <a href="<?php echo CommonHelper::generateUrl('Buyer', 'orderCancellationRequest', array($childOrderDetail['op_id'])); ?>" class="icn-highlighted" title="<?php echo Labels::getLabel('LBL_Cancel_Order', $siteLangId); ?>"><i class="fa fa-close"></i></a>
                        </li>
                        <?php }
                        ...
                        if ($canReturnRefund) { ?>
						<li>
							<a href="<?php echo CommonHelper::generateUrl('Buyer', 'orderReturnRequest', array($childOrderDetail['op_id'])); ?>" class="icn-highlighted" title="<?php echo Labels::getLabel('LBL_Refund', $siteLangId); ?>"><i class="fa fa-dollar"></i></a>
						</li>
						<?php } ?>
					</ul>
                <?php } ?>
            ...
            <div class="cards">
                <div class="cards-header p-4">
                    ...
                    <div class="action">
                        <div class="">
                            ...
                            <a href="<?php echo CommonHelper::generateUrl('Buyer', 'rentalOrders'); ?>" class="btn btn--primary-border btn--sm no-print"><?php echo Labels::getLabel('LBL_Back_to_order', $siteLangId); ?></a>
							<?php if (FatApp::getConfig("CONF_DEFAULT_DEIVERED_ORDER_STATUS") == $childOrderDetail["op_status_id"] && true == $primaryOrder && $childOrderDetail['opd_extend_from_op_id'] <= 0 && empty($extendChildOrder) ) { ?>
								<a href="<?php echo CommonHelper::generateUrl('Products', 'View', array($childOrderDetail['selprod_id'], $childOrderDetail['op_id']));?>" class="btn btn--primary-border btn--sm no-print">
                ...
                <div class="cards-content pl-4 pr-4 ">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="info--order">
                                ...
                                <p>
									...
									<?php echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($childOrderDetail, 'CART_TOTAL')); ?>
								</p>
                                <p>
									<strong>
										<?php echo Labels::getLabel('LBL_Delivery', $siteLangId); ?>: 
									</strong>
									<?php echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($childOrderDetail, 'SHIPPING')); ?>
								</p>
                                <p>
									<strong>
										<?php echo Labels::getLabel('LBL_Tax', $siteLangId); ?>:
									</strong> 
									<?php echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($childOrderDetail, 'TAX')); ?>
								</p>
                                <p>
									<strong>
										<?php echo Labels::getLabel('LBL_Discount', $siteLangId); ?>:
									</strong> 
									<?php echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($childOrderDetail, 'DISCOUNT')); ?>
								</p> 
								<?php 
								...
								<p>
									...
									<?php echo CommonHelper::displayMoneyFormat($rewardPointDiscount); ?>
								</p> 
								<?php } ?> 
								<p>
									<strong>
									...
									<?php 
									//echo "<pre>"; print_r($childOrderDetail); echo "</pre>";
									echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($childOrderDetail)); ?>
								</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mb-4">
					...
					<table class="table  table--orders">
                        <tbody>
                            <tr class="">
                                ...
                                <?php } ?>
								<th><?php echo Labels::getLabel('LBL_Rental_Security', $siteLangId);?></th>
								<th><?php echo Labels::getLabel('LBL_Rental_Duration', $siteLangId);?></th>
								<th><?php echo Labels::getLabel('LBL_Qty', $siteLangId);?></th>
								<th><?php echo Labels::getLabel('LBL_Rental_Price', $siteLangId);?></th>
                            ...
                            if ($primaryOrder) {
								...
								$selfPickup = $childOrderDetail['opd_rental_is_pickup'];
								$shopName = $childOrderDetail['op_shop_name'];
                            } else {
                                $arr = $childOrderDetail;
                            }
                            ...
                            foreach ($arr as $childOrder) {
								...
								$shopId = $childOrder['op_shop_id'];
								$shopAddress = Shop::getShopAddress($shopId);
								//echo "<pre>"; print_r($shopAddress); echo "</pre>";
								?>
                                <tr>
                                    <?php if (!$print) { ?>
                                        <td class="no-print">
                                    ...
                                    <td>
                                        <div class="item__description">
                                            ...
                                            <div class="item__category">
                                                ...
                                                href = "<?php echo CommonHelper::generateUrl('Products', 'view', array($childOrder['op_selprod_id'])); ?>">
													<?php echo $childOrder['op_product_name']; ?> 
												</a>
                                            </div>
                                            <?php } ?>
                                            <div class="item__brand">
												<?php echo Labels::getLabel('Lbl_Brand', $siteLangId)?>: <?php echo CommonHelper::displayNotApplicable($siteLangId, $childOrder['op_brand_name']); ?>
											</div>
                                            ...
                                            <?php if ($childOrder['op_shipping_duration_name'] != '') { ?>
                                                <div class="item__shipping">
													<?php echo Labels::getLabel('LBL_Shipping_Method', $siteLangId); ?>: <?php echo $childOrder['op_shipping_durations'].'-'. $childOrder['op_shipping_duration_name']; ?>
												</div>
                                            <?php } ?>
                                        </div>
                                    </td>
									...
									<td>
										<?php echo CommonHelper::displayMoneyFormat($childOrder['opd_rental_security']); ?>
									</td>
									<td>
										<?php echo Labels::getLabel('LBL_Duration:', $siteLangId).' '.$childOrder['opd_rental_price_multiplier']; ?> <br />
										<?php 
										echo Labels::getLabel('LBL_From:', $siteLangId). ' '. date('M d, h:i A', strtotime($childOrder['opd_rental_start_date']));
										?><br />
										<?php 
										echo Labels::getLabel('LBL_To:', $siteLangId). ' '. date('M d, h:i A', strtotime($childOrder['opd_rental_end_date']));
										?>
									</td>
									<td><?php echo $childOrder['op_qty']; ?></td>
									<td>
										<?php echo CommonHelper::displayMoneyFormat($childOrder['opd_rental_price']);?> 
										<?php echo $rentalTypeArr[$childOrder['opd_rental_type']]?>
									</td>
									<td>
										<?php echo CommonHelper::displayMoneyFormat($childOrder['op_unit_price']);?>
									</td>
								</tr>
                            <?php }
                            if (!$primaryOrder) { ?>
                    ...
                    <div class="row">
                        ...
                        <?php if (!empty($orderDetail['shippingAddress']) && $productType != Product::PRODUCT_TYPE_DIGITAL && $selfPickup < 1) { ?>
                            <div class="col-lg-6 col-md-6 mb-4">
						...
						<div class="col-lg-6 col-md-6 mb-4">
							...
							<?php 
								$pickupAddress = $shopName.'<br>';
                                if ($shopAddress['state_identifier']!='') {
                                    $pickupAddress.=$shopAddress['state_identifier'].'<br>';
                                }

                                if ($shopAddress['shop_postalcode']!='') {
                                    $pickupAddress.=$shopAddress['shop_postalcode'].'<br>';
                                }

                                if ($shopAddress['country_code']!='') {
                                    $pickupAddress.=$shopAddress['country_code'].'<br />';
                                }

                                if ($shopAddress['shop_phone']) {
                                    $pickupAddress.= Labels::getLabel('LBL_Contact:', $siteLangId).' '.$shopAddress['shop_phone'];
                                }
							?> 
							<div class="info--order">
                        ...
                        <table class="table  table--orders">
                            ...
                            foreach ($digitalDownloadLinks as $key=>$row) {
								...
								<tr>
                                    <td><?php echo $sr_no; ?></td>
                                    <td>
										<a target="_blank" onClick="<?php echo $linkOnClick; ?> " href="<?php echo $linkUrl; ?>" data-link="<?php echo $linkUrl; ?>" title="<?php echo $linkTitle; ?>"><?php echo $link; ?></a>
									</td>
                                    <td><?php echo $downloadableCount; ?></td>
