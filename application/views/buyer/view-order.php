                        ...
                        <div class="panel__body">
                            <div class="box box--white box--space">
                                <div class="box__head" >
                                    ...
                                    <?php if( !$print ){  ?>
                                        <div class="group--btns no-print">
                                            <a href="<?php echo Fatutility::generateUrl('buyer','viewOrder',$urlParts) . '/print'; ?>" class="btn btn--primary  btn--sm no-print">
                                                <?php echo Labels::getLabel('LBL_Print',$siteLangId);?>
                                            </a>
                                            <a href="<?php echo CommonHelper::generateUrl('Buyer','orders');?>" class="btn btn--secondary btn--sm">
                    ...
                    <table class="table  table--orders">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo ($row['oshistory_orderstatus_id']>0)?$orderStatuses[$row['oshistory_orderstatus_id']]:CommonHelper::displayNotApplicable($siteLangId,''); echo ($row['oshistory_tracking_number'])? ': '.Labels::getLabel('LBL_Tracking_Number',$siteLangId).' '.$row['oshistory_tracking_number']." VIA <em>".$row['op_shipping_duration_name']."</em>" :'' ?></td>
