					  ...
					  <div class="row">
						...
						<div class="col-md-5 col-sm-5">
						  <?php /* <ul class="links--inline align--right">
							<li><a href="javascript:void(0);" onclick="reviewAbuse(<?php echo $reviewData['spreview_id'] ?>);return false;"><?php echo Labels::getLabel('Lbl_Report_Abuse',$siteLangId); ?></a></li></ul> */ ?>
						</div>
					  </div>
					</div>
				  </div>
