    ...
    <div class="bg--second pt-3 pb-3">
      <div class="container container--fixed">
        <div class="row justify-content-between">
                ...
                <div class="prod-info">
                        ...
                        <div class="prod-info__right">
                            ...
                            <?php if($product['selprod_title']){ ?>
                              <h6><?php echo $product['selprod_title']; ?> </h5>
          ...
          <div class="col-md-auto col-sm-auto"><a href="<?php echo CommonHelper::generateUrl('Products','view',array($product['selprod_id'])); ?>" class="btn btn--secondary"><?php echo Labels::getLabel('Lbl_Back_to_Product',$siteLangId); ?></a></div>
