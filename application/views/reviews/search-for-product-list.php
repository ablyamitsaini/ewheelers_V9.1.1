	...
	<div class="listings__repeated">
		<div class="col-md-3">
			...
			<li class="<?php echo $j<=round($review["prod_rating"])?"active":"in-active" ?>">
				...
				<g><path d="M51,42l5.6,24.6L35,53.6l-21.6,13L19,42L0,25.4l25.1-2.2L35,0l9.9,23.2L70,25.4L51,42z M51,42" fill="<?php echo $j<=round($review["prod_rating"])?"#ff3a59":"#474747" ?>" /></g></svg>
			</li>
			<?php } ?>
			</ul>
			</div>
