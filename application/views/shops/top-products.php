				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="share-this">
							...
							</a> <a class="social-link" href="#" target="_blank">
								<i class="icn"><svg class="svg">
		...
		<div class="container">
			<div class="section-head section--white--head section--head--center">
				<div class="section__heading">
					<h2> <?php echo Labels::getLabel('LBL_TOP_PRODUCTS', $siteLangId)?> 
	...
	<section class="section">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-7">
					<?php $this->includeTemplate('_partial/productsSearchForm.php',array('frmProductSearch'=>$frmProductSearch,'siteLangId'=>$siteLangId,'doNotdisplaySortBy'=>true),false);  ?>
				</div>
			</div>
		</div>
	</section>
