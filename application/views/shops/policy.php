...
<?php
    ...
    if (!empty($shop['shop_payment_policy']) || !empty($shop['shop_delivery_policy']) || !empty($shop['shop_refund_policy']) || !empty($shop['shop_additional_info']) || !empty( $shop['shop_seller_info'] != '')) {
            ...
            <div class="white--bg padding20">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
                        <?php
                    foreach ($shopPolicyArr as $key) {
                        if (!empty($shop[$key])) {
                            ?>
                            <div class="container--cms">
                                <h4><?php echo $shop[$key]['title']; ?></h4>
                                <p><?php echo nl2br($shop[$key]['description']); ?></p>
                            </div>
                            <?php
                        }
                    }
    ...
    <?php } ?>
<div class="gap"></div>
</div> <?php echo $this->includeTemplate('_partial/shareThisScript.php'); ?> <script type="text/javascript">
    (function($) {
