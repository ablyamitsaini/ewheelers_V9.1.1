...
<div id="body" class="body bg--shop" <?php if($showBgImage){ echo 'style="background: url('.$bgUrl.') repeat 0 0;"'; } ?>>
	...
	l3.241-3.159C14.737,5.803,14.854,5.65,14.854,5.49z"></path>
              ...
              <div class=""> 
				  <a href="javascript:void(0)" class="btn btn--primary ripplelink block-on-mobile" tabindex="0"><?php echo Labels::getLabel('LBL_Love', $siteLangId);  echo " ".$shop['shop_name']; ?> !</a> 
