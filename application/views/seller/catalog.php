 ...
 <div class="content-wrapper content-space">
	...
	<div class="content-body">
		<div class="cards">
          ...
          <?php echo Labels::getLabel('LBL_Search_Products',$siteLangId); ?></h5>


<div class="action">
<?php if( User::canAddCustomProduct() ){ ?>
<div id="tour-step-2" >
<a href="<?php echo CommonHelper::generateUrl('seller','customProductForm');?>" class = "link"><?php echo Labels::getLabel( 'LBL_Add_New_Product', $siteLangId);?></a>
</div>
<?php }?>
