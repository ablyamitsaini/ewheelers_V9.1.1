            ...
            <div class="cards">
                <section class="top-space">
                    <div class="packages-banner">
                        <div class="container">
                            <div class="banner-over-txt"> <?php echo html_entity_decode($pageData['epage_content']);?> </div>
                        </div>
                    </div>
                    <div class="container">
                                        ...
                                        <div class=" col-lg-<?php echo $lgCols; ?> col-md-<?php echo $mdCols; ?> col-sm-6 col-xs-12 box <?php echo $packageArrClass[$inc]." ".$selectedClass ?>">
                                            <div class="box-inner">
                                                ...
                                                <div class="trial">
                                                    <ul>
                                                        <li>
                                                            <span><?php echo CommonHelper::displayComissionPercentage($package[SellerPackages::DB_TBL_PREFIX.'commission_rate']); ?>%</span> <?php echo Labels::getLabel('LBL_Commision_rate', $siteLangId); ?>
                                                        </li>
                                                        <li>
