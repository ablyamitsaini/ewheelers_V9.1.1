...
$dateFromFld->setWrapperAttribute('class','col-sm-2 col-md-2 col-lg-2');
...
$dateToFld->setWrapperAttribute('class','col-sm-2 col-md-2 col-lg-2');
...
$submitBtnFld->setWrapperAttribute('class','col-sm-2 col-md-2 col-lg-2');
$submitBtnFld->developerTags['col'] = 2;

$cancelBtnFld = $frmOrderSrch->getField('btn_clear');
$cancelBtnFld->setFieldTagAttribute('class','btn--block');
$cancelBtnFld->setWrapperAttribute('class','col-sm-2 col-md-2 col-lg-2');
