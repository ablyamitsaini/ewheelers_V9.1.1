						...
						<div class="panel__body">
                             <div class="box box--white box--space">
                               <div class="box__head" >
                                   ...
                                   <?php if( !$print ){ ?>
                                       <div class="group--btns no-print"><a href="<?php echo CommonHelper::generateUrl('Seller','sales');?>" class="btn btn--secondary btn--sm"><?php echo Labels::getLabel('LBL_Back_to_order',$siteLangId);?></a></div>
                                   <?php } ?>
                               </div>
                                <div class="box__body">
                                             ...
                                             <div class="row">
                                                 ...
                                                 <div class="col-lg-6 col-md-6 col-sm-6">
                                                     <div class="info--order">
                                                        ...
                                                        <?php if( !$print ){ ?>
                                                         <a href="<?php echo Fatutility::generateUrl('seller','viewOrder',$urlParts) . '/print'; ?>" class="btn btn--primary no-print"><?php echo Labels::getLabel('LBL_Print',$siteLangId);?></a>
                                                        <?php } ?>
