...
<tr id="row-<?php echo $insertId; ?>">
    ...
    <td>
        ...
        <input type="text" data-id="<?php echo $insertId; ?>" value="<?php echo $post['voldiscount_percentage']; ?>" data-selprodid="<?php echo $post['voldiscount_selprod_id']; ?>" name="voldiscount_percentage" class="js--volDiscountCol hidden vd-input" data-val="<?php echo $post['voldiscount_percentage']; ?>"/>
    </td>
    <td>
        <ul class="actions">
            <li><a title="Delete" href="javascript:void(0);" onclick="deleteSellerProductVolumeDiscount(<?php echo $insertId; ?>)"><i class="fa fa-trash"></i></a></li>
        </ul>
    </td>
</tr>
