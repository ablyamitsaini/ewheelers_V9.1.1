	...
	<div class="tabs tabs--small tabs--scroll clearfix">
		<ul>
			...
			foreach($languages as $langId=>$langName){
				?>
				<li class="<?php echo $inactive;?> <?php echo ($langId == $brandReqLangId) ? 'is-active' : ''; ?>"><a href="javascript:void(0);" <?php if($brandReqId>0){?> onclick="addBrandReqLangForm(<?php echo $brandReqId ?>, <?php echo $langId;?>);" <?php }?>><?php echo $langName;?></a></li>
			<?php } ?>
