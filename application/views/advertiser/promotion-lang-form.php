...
$langFrm->developerTags['colClassPrefix'] = 'col-lg-12 col-md-';
...
<div class="tabs tabs--small   tabs--scroll clearfix setactive-js rtl">
	<ul>
		...
		foreach($languages as $langId => $langName){?>
			<li class="<?php echo ($promotion_lang_id == $langId)?'is-active':''?>"><a href="javascript:void(0)" <?php if($promotionId>0){ ?> onClick="promotionLangForm(<?php echo $promotionId;?>,<?php echo $langId;?>)" <?php }?>>
