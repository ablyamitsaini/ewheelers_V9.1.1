            ...
            <div class="detail-wrapper">
               ...
               ?>
                  ...
                  ?>
                        ...
                        <div class="col-lg-5">
                            <div class="product-description">
                                <div class="product-description-inner">
                                            ...
                                            <div class="qty-wrapper">
                                                <div class="quantity" data-stock="9900">
                                                    ...
                                                    <div class="qty-input-wrapper" data-stock="9900">
                                                        <input maxlength="3" class="qty-input cartQtyTextBox productQty-js" title="Quantity"
                                                            data-fatreq="{&quot;required&quot;:false,&quot;integer&quot;:true,&quot;range&quot;:{&quot;minval&quot;:0,&quot;maxval&quot;:9999999999,&quot;numeric&quot;:true}}" type="text"
                                    ...
                                    <div class="gap"></div>
                                    <div class="buy-group">
                                        <button name="btnProductBuy" type="submit" id="btnProductBuy" class="btn btn--primary add-to-cart--js btnBuyNow"> Buy Now</button><button name="btnAddToCart" type="submit" id="btnAddToCart"
                                            class="btn btn--secondary   btn--primary-border add-to-cart--js">Add To Cart</button><input title="" data-fatreq="{&quot;required&quot;:false}" type="hidden" name="selprod_id" value="118"> </div>
                                    <div class="gap"></div>
                    ...
                    ?>
                                        <li>
                                            <div class="qty__value"><?php echo ($volumeDiscountRow['voldiscount_min_qty']); ?> <?php echo Labels::getLabel('LBL_Or_more',$siteLangId);?> (<?php echo $volumeDiscountRow['voldiscount_percentage'].'%';?>)
                                                <span class="item__price"><?php echo CommonHelper::displayMoneyFormat($price); ?> / <?php echo Labels::getLabel('LBL_Product',$siteLangId);?></span><span
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="cms bg-gray p-4 mb-4">
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
                                Nemo enim ipsam voluptatem quia voluptas sit illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit </p>
                        </div>
                        ...
                        <div class="cms bg-gray p-4 mb-4">
                            ...
                            <p>We accept PayPal. You may use a credit card on PayPal without creating a PayPal account. Click the "Check out with PayPal" button. You'll be taken to a secure page on PayPal. Look for a link below the log-in form
                                reading "Don't have a PayPal account?" You'll then be prompted to fill in your billing and credit card information.</p>
                            <br>
                            <h6>Shipping </h6>
                            <p>All Items shipped via International registered air mail within 1-3 work days (according to the Israeli calender). Once the item is shipped an email with a tracking number will be sent to you to enable you track the
                                package status. Express shipping is available - you may contact us for specific information. Any additional costs that may be charged due to the customer's local duty or tax laws will be payed by the customer. We are
                                shipping to the address you provided, please make sure it is correct.</p>
                            <br>
                            <h6>Refunds Exchanges</h6>
                            <p>We do not offer refunds - Exchange only. Please mark all returns for exchange as "Returned Goods" on the customs form and send items back via REGULAR post, otherwise there is a C.O.D. charge that will be charged to the
                                customer. The customer is responsible for shipping fees and customs costs if any. Once the order is received at our end, we will send you the exchange item. Please ask any questions you have before purchasing!</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="products__rating"> <i class="icn"><svg class="svg">
                                    <use xlink:href="/yokartv8/images/retina/sprite.svg#star-yellow" href="/yokartv8/images/retina/sprite.svg#star-yellow"></use></svg></i> <span class="rate">2.7<span></span></span>
                                </div>
                        ...
                        <div class="listing__all">
                                        ...
                                        <div class="col-md-9">
                                            <div class="reviews-desc">
                                                ...
                                                <div class="cms">
                                                    ...
                                                    <p>
                                                        <span class="lessText">The toy was perfect - just what I was looking for. The item was very reasonably priced, they arrived in perfect condition, and earlier than promised. Importantly, the toy
                                                            looked exactly like their onl</span>
                                                        <span class="moreText" hidden="">
                                                            The toy was perfect - just what I was looking for. The item was very reasonably priced, they arrived in perfect condition, and earlier than promised. Importantly, the toy looked exactly like
                                                            their online photo and description. A hassle-free buying experience! </span>
                            ...
                            <div class="gap"></div>
                            <form name="frmSearchReviewsPaging"><input type="hidden" name="selprod_id" value="122"><input type="hidden" name="page" value=""><input type="hidden" name="pageSize" value="5"><input type="hidden" name="orderBy"
                                    value="most_helpful"><input type="hidden" name="fOutMode" value="json"><input type="hidden" name="fIsAjax" value="1"></form>
                        </div>
