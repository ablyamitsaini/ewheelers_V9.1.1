...
if ($products) {
    ...
    foreach ($products as $product) {
        $productUrl = CommonHelper::generateUrl('Products', 'View', array($product['selprod_id'])); ?> <div class="col-lg-3 col-md-<?php echo (isset($colMdVal) && $colMdVal > 0)?$colMdVal:4; ?> column">
    <!--product tile-->
    <div class="products">
