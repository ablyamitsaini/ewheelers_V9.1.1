...
class SellerController extends SellerBaseController
{
    ...
    public function checkIfAvailableForInventory($productId)
    {
        ...
        if (!$available) {
            FatUtility::dieJsonError(Labels::getLabel('Inventory_for_all_possible_product_options_have_been_added._Please_access_the_shop_inventory_section_to_update', $this->siteLangId));
        }
