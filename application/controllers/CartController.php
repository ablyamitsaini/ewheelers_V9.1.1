...
class CartController extends MyAppController
{
    ...
    public function add()
    {
        ...
        $this->addProductToCart($productsToAdd, $selprod_id, $productFor, $rentalData);
        if (true ===  MOBILE_APP_API_CALL) {
            $cartObj = new Cart();
    ...
    private function addProductToCart($productsToAdd, $selprod_id, $productFor, $rentalData = array())
    {
        $ProductAdded = false;
