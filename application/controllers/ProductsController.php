...
class ProductsController extends MyAppController
{
    ...
    public function track($productId = 0)
    {
        ...
        $productSrchObj->addMultipleFields(
            ...
            'special_price_found', 'splprice_display_list_price', 'splprice_display_dis_val', 'splprice_display_dis_type',
            'theprice', 'selprod_price','selprod_stock', 'selprod_condition','prodcat_id','COALESCE(prodcat_name, prodcat_identifier) as prodcat_name','COALESCE(sq_sprating.prod_rating,0) prod_rating ','selprod_sold_count','selprod_test_drive_enable','selprod_book_now_enable')
        );
