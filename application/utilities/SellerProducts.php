...
trait SellerProducts
{
    ...
    public function sellerProductForm($product_id, $selprod_id = 0)
    {
        ...
        if (0 == $selprod_id && SellerProduct::getActiveCount(UserAuthentication::getLoggedUserId()) >= SellerPackages::getAllowedLimit(UserAuthentication::getLoggedUserId(), $this->siteLangId, 'spackage_inventory_allowed')) {
