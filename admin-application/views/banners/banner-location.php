	...
	<div class="tabs_nav_container responsive flat">
		<ul class="tabs_nav">
			...
			foreach($languages as $langId=>$langName){?>
				<li class="<?php echo $inactive;?>"><a href="javascript:void(0);" <?php if( $bLocationId > 0 ){ ?> onclick="bannerLocationLangForm(<?php echo $bLocationId ?>, <?php echo $langId;?>);" <?php } ?>><?php echo Labels::getLabel('LBL_'.$langName,$adminLangId); ?></a></li>
			<?php } ?>
