			...
			<div class="row"> 		
				<section class="section">
					<div class="sectionbody">
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="shop-template fixed-height-div">
								<a rel="facebox" onClick="displayImageInFacebox('<?php echo CommonHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/collection_layouts/layout-2.jpg');" href="javascript:void(0)">
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="min-height:500px">
							<div class="shop-template fixed-height-div">
								<a rel="facebox" onClick="displayImageInFacebox('<?php echo CommonHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/collection_layouts/layout-3.jpg');" href="javascript:void(0)">
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="min-height:500px">
							<div class="shop-template fixed-height-div">
								<a rel="facebox" onClick="displayImageInFacebox('<?php echo CommonHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/collection_layouts/layout-4.jpg');" href="javascript:void(0)">
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="shop-template fixed-height-div">
								<a rel="facebox" onClick="displayImageInFacebox('<?php echo CommonHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/collection_layouts/layout-5.jpg');" href="javascript:void(0)">
