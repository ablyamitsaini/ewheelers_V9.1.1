		...
		switch ($key){
			...
			case 'action':
				...
				if($canEdit){
					...
					'title'=>Labels::getLabel('LBL_Edit',$adminLangId),"onclick"=>"editStateFormNew(".$row['state_id'].")"),Labels::getLabel('LBL_Edit',$adminLangId), 
					true);				
				}
			break;
			case 'state_active':
					...
					//$str = '<div class="checkbox-switch"><input '.$active.' type="checkbox" id="switch'.$row['state_id'].'" value="'.$row['state_id'].'" onclick="'.$statucAct.'"/><label for="switch'.$row['state_id'].'">Toggle</label></div>';
					$str='<label class="statustab -txt-uppercase">
                     <input '.$active.' type="checkbox" id="switch'.$row['state_id'].'" value="'.$row['state_id'].'" onclick="'.$statucAct.'" class="switch-labels"/>
