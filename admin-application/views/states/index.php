				...
				<div class="page__title">
					...
					<div class="row">
						<div class="col--first col-lg-6">
							...
							<h5><?php echo Labels::getLabel('LBL_Manage_States',$adminLangId); ?> </h5>
			...
			<div class="sectionhead">
				...
				$ul = new HtmlElement( "ul",array("class"=>"actions actions--centered") );
				 ...
				 if(FatApp::getConfig('CONF_ENABLE_IMPORT_EXPORT',FatUtility::VAR_INT,0) && $canEdit){
							...
							$innerLiImport->appendElement('a', array('href'=>'javascript:void(0)','class'=>'button small green','title'=>Labels::getLabel('LBL_Import',$adminLangId),"onclick"=>"addImportForm(". Importexport::TYPE_STATE.")"),Labels::getLabel('LBL_Import',$adminLangId), true);
