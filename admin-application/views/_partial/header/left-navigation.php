        ...
        <aside class="leftside">
            ...
            <div class="sidebar_inner">
                 <div class="profilewrap">
                        <div class="profilecover">
                            <figure class="profilepic"><img id="leftmenuimgtag"  src="<?php echo CommonHelper::generateUrl('image', 'profileImage', array(AdminAuthentication::getLoggedAdminId(), "THUMB", true )).'?'.time(); ?>" alt=""></figure>
			...
			<li class="haschild"><a href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Users',$adminLangId);?></a>
				<ul>
					...
					<li><a href="<?php echo CommonHelper::generateUrl('userRequests');?>"><?php echo Labels::getLabel('LBL_Users_Requests',$adminLangId);?> <?php if($supReqCount){ ?><span class='badge'>(<?php echo $supReqCount; ?>)</span><?php } ?></a></li>
					<?php }?>
				</ul>
			</li>
			<?php }?>
