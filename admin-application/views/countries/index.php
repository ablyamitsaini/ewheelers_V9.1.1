				...
				<div class="page__title">
					...
					<div class="row">
						<div class="col--first col-lg-6">
							...
							<h5><?php echo Labels::getLabel('LBL_Manage_Countries',$adminLangId); ?> </h5>
		...
		<section class="section">
			<div class="sectionhead">
				...
				<?php 
					...
					/*<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="exportForm(<?php echo Importexport::TYPE_COUNTRY;?>)";><?php echo Labels::getLabel('LBL_Export',$adminLangId); ?></a>*/
					}
					 if(FatApp::getConfig('CONF_ENABLE_IMPORT_EXPORT',FatUtility::VAR_INT,0) && $canEdit){


							$innerLiImport=$innerUl->appendElement('li');
							$innerLiImport->appendElement('a', array('href'=>'javascript:void(0)','class'=>'button small green','title'=>Labels::getLabel('LBL_Import',$adminLangId),"onclick"=>"addImportForm(". Importexport::TYPE_COUNTRY.")"),Labels::getLabel('LBL_Import',$adminLangId), true);

						/*<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="import_request_variables(types)Form(<?php echo Importexport::TYPE_COUNTRY;?>)";><?php echo Labels::getLabel('LBL_Import',$adminLangId); ?></a>*/
						}
					if($canEdit){
					 ...
					 /*
						<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="countryForm(0)";><?php echo Labels::getLabel('LBL_Add_Country',$adminLangId); ?></a>		*/	
						} 
						echo $ul->getHtml();
						?>
					</div>
