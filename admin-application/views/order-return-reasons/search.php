		...
		switch ($key){
			...
			case 'action':
				...
				if($canEdit){
					...
					'title'=>Labels::getLabel('LBL_Edit',$adminLangId),"onclick"=>"editReasonFormNew(".$row['orreason_id'].")"),Labels::getLabel('LBL_Edit',$adminLangId), 
					true);
              		$innerLiDelete=$innerUl->appendElement('li');
					$innerLiDelete->appendElement('a', array('href'=>'javascript:void(0)', 'class'=>'button small green', 
					'title'=>Labels::getLabel('LBL_Delete',$adminLangId),"onclick"=>"deleteRecord(".$row['orreason_id'].")"),	Labels::getLabel('LBL_Delete',$adminLangId), 
					true);
				}
			break;
			default:
