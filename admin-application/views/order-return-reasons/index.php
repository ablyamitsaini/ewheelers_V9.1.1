				...
				<div class="page__title">
					<div class="row">
						<div class="col--first col-lg-6">
							...
							<h5><?php echo Labels::getLabel('LBL_Manage_Order_Return_Reasons',$adminLangId); ?> </h5>
		...
		<div class="sectionhead">
            ...
            $innerUl=$innerDiv->appendElement('ul',array('class'=>'linksvertical'));
               ...
               $innerLiAddCat->appendElement('a', array('href'=>'javascript:void(0)','class'=>'button small green','title'=>Labels::getLabel('LBL_Add_Reason',$adminLangId),"onclick"=>"addReasonForm(0)"),Labels::getLabel('LBL_Add_Reason',$adminLangId), true);
				...
				/*<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="reasonForm(0)";><?php echo Labels::getLabel('LBL_Add_Reason',$adminLangId); ?></a>	*/		
 			} ?>
		</div>
