      ...
      <div class="row">
		...
		<section class="section">
            ...
            //           		$innerLi=$innerUl->appendElement('li'); 
				...
				<?php }?>
				<?php /*if(FatApp::getConfig('CONF_ENABLE_IMPORT_EXPORT',FatUtility::VAR_INT,0) && $canView){?>
					<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="exportForm(<?php echo Importexport::TYPE_OPTIONS;?>)";><?php echo Labels::getLabel('LBL_Export_Option',$adminLangId); ?></a>
				<?php }?>	
				<?php if(FatApp::getConfig('CONF_ENABLE_IMPORT_EXPORT',FatUtility::VAR_INT,0) && $canEdit){?>
					<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="importForm(<?php echo Importexport::TYPE_OPTIONS;?>)";><?php echo Labels::getLabel('LBL_Import_Option',$adminLangId); ?></a>
				<?php } */?>
               ...
               $innerLiAddCat->appendElement('a', array('href'=>'javascript:void(0)','class'=>'button small green','title'=>Labels::getLabel('LBL_Add_New_Option',$adminLangId),"onclick"=>"addOptionFormNew(0)"),Labels::getLabel('LBL_Add_New_Option',$adminLangId), true);
					?>
				<!--<a href="javascript:void(0)" class="themebtn btn-default btn-sm" onClick="optionForm(0)";><?php echo Labels::getLabel('LBL_Add_New_Option',$adminLangId); ?></a>-->
				<?php }	
				echo $ul->getHtml();
				 ?>
			</div>
