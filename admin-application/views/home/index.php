                ...
                <div class="space">
                    ...
                    <div class="row">	
						...
						<div class="tabs_nav_container responsive boxbased">
							<ul class="tabs_nav">
								<li><a class="active" rel="tabs_01" href="javascript:void(0)"><i class="icon ion-arrow-graph-up-right"></i> <?php echo Labels::getLabel("LBL_Statistics", $adminLangId); ?></a></li>
								<li><a rel="tabs_02" href="javascript:void(0)"><i class="icon ion-bag"></i> <?php echo Labels::getLabel("LBL_Seller_Products", $adminLangId); ?></a></li>
								<li><a rel="tabs_03" href="javascript:void(0)"><i class="icon ion-ios-cart"></i><?php echo Labels::getLabel("LBL_Shops", $adminLangId); ?></a></li>
								<li><a rel="tabs_04" href="javascript:void(0)"><i class="icon ion-android-person"></i> <?php echo Labels::getLabel("LBL_Buyer/Seller_Signups", $adminLangId); ?></a></li>
								<li><a rel="tabs_05" href="javascript:void(0)"><i class="icon ion-android-person"></i> <?php echo Labels::getLabel("LBL_Advertiser_Signups", $adminLangId); ?></a></li>
								<li><a rel="tabs_06" href="javascript:void(0)"><i class="icon ion-android-contact"></i>  <?php echo Labels::getLabel("LBL_Affiliate_Signups", $adminLangId); ?></a></li>
							</ul>
							...
							<div class="tabs_panel_wrap nopadding">
								...
								<!-- Affiliates List[ -->
								<span class="togglehead" rel="tabs_06"><?php echo Labels::getLabel("LBL_Advertisers", $adminLangId); ?></span>
