...
$langFld->addFieldTagAttribute('class','bg-language-js');
        ...
        <div class="sectionbody space">
			...
			foreach($languages as $langId=>$langName){?>
                                ...
                                <?php } ?>
                                    ...
                                    <li><a class="active" href="javascript:void(0);" <?php if($shop_id>0){?> onclick="shopMediaForm(<?php echo $shop_id ?>);" <?php }?>><?php echo Labels::getLabel('LBL_Media',$adminLangId); ?></a></li>
