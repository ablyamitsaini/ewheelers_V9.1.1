<?php defined('SYSTEM_INIT') or die('Invalid Usage.');?> <section class="section">
    <div class="sectionhead">
        ...
        <a class="btn-default btn-sm" href="javascript:void(0); " onClick="sellerProductSpecialPriceForm(<?php echo $selprod_id; ?>, 0);" style='float:right;'><?php echo Labels::getLabel('LBL_Add_New_Special_Price', $adminLangId)?></a>
    </div>
    <div class="sectionbody space">
        <div class="row">
            <div class="col-sm-12">
                <!--    <a class="themebtn btn-default btn-sm" href="javascript:void(0); " onClick="sellerProductSpecialPriceForm(<?php echo $selprod_id; ?>, 0);"><?php echo Labels::getLabel('LBL_Add_New_Special_Price', $adminLangId)?></a>-->
