	...
	foreach ($arr_flds as $key=>$val){
		...
		switch ($key){
			...
			case 'selprod_active';
				...
				//$str = '<div class="checkbox-switch"><input '.$active.' type="checkbox" id="switch'.$row['selprod_id'].'" value="'.$row['selprod_id'].'" onclick="'.$statucAct.'"/><label for="switch'.$row['selprod_id'].'">Toggle</label></div>';
				$str= '<label class="statustab -txt-uppercase">
					   <input '.$active.' type="checkbox" id="switch'.$row['selprod_id'].'" value="'.$row['selprod_id'].'" onclick="'.$statucAct.'" class="switch-labels"/>
