...
class BrandsController extends AdminBaseController
{
    ...
    public function getMediaForm( $brand_id )
    {
        ...
        $frm->addButton(
            Labels::getLabel('Lbl_Logo', $this->adminLangId), 'logo', Labels::getLabel('LBL_Upload_Logo', $this->adminLangId),
    ...
    private function getRequestForm($brand_id=0)
    {
        ...
        $frm->addSelectBox(Labels::getLabel('LBL_brand_status', $this->adminLangId), 'brand_status', $reqStatusArr, '', array('class'=>'small'), '');
        $activeInactiveArr = applicationConstants::getActiveInactiveArr($this->adminLangId);
    ...
    public function autoComplete()
    {
        ...
        $srch->joinTable(
            Brand::DB_TBL . '_lang', 'LEFT OUTER JOIN',
    ...
    public function exportBrands()
    {
        ...
        CommonHelper::convertToCsv($sheetData, 'Brands_'.$langData['language_code'].'_'.date("d-M-Y").'.csv', ','); exit;
    }
    ...
    public function exportMedia()
    {
        ...
        CommonHelper::convertToCsv($sheetData, 'Brands_Media_'.$languageCodes[$langId].'_'.date("d-M-Y").'.csv', ','); exit;
    }
