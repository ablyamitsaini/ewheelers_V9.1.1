...
class SlidesController extends AdminBaseController {
	...
	public function setUpImage($slide_id){
		...
		if(!$res = $fileHandlerObj->saveAttachment($_FILES['file']['tmp_name'],AttachedFile::FILETYPE_HOME_PAGE_BANNER, $slide_id, 0,
		$_FILES['file']['name'], -1, true,$lang_id,$slide_screen)
		){
