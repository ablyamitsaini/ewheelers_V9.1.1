...
class ShopsController extends AdminBaseController {
	...
	public function uploadShopImages($shop_id, $lang_id){
		...
		if(!$res = $fileHandlerObj->saveAttachment($_FILES['file']['tmp_name'], $file_type, $shop_id, 0,
	...
	private function getShopLogoForm($shop_id,$land_id){
		...
		$fld = $frm->addButton(Labels::getLabel('LBL_Logo',$land_id),'shop_logo',Labels::getLabel('LBL_Upload',$land_id),
	...
	public function shopCollectionGeneralForm($shop_id){
		$post = FatApp::getPostedData();
