...
class ConfigurationsController extends AdminBaseController
{
    ...
    public function uploadMedia()
    {
        ...
        if(!$res = $fileHandlerObj->saveAttachment(
            $_FILES['file']['tmp_name'], $file_type, 0, 0,
    ...
    private function getForm( $type , $arrValues = array() )
    {
        ...
        case Configurations::FORM_LOCAL:
            $frm->addSelectBox(
                Labels::getLabel('LBL_Default_Site_Laguage', $this->adminLangId), 'CONF_DEFAULT_SITE_LANG',
        ...
        case Configurations::FORM_PRODUCT:
            ...
            $fld4 = $frm->addCheckBox(
                Labels::getLabel("LBL_Allow_Seller_to_add_products", $this->adminLangId), 'CONF_ENABLED_SELLER_CUSTOM_PRODUCT', 1,
                array(), false, 0
            );
            ...
            $fld4 = $frm->addCheckBox(
                Labels::getLabel("LBL_Allow_Sellers_to_request_products_which_is_availble_to_all_sellers", $this->adminLangId), 'CONF_SELLER_CAN_REQUEST_CUSTOM_PRODUCT', 1,
                array(), false, 0
            );
        ...
        case Configurations::FORM_USER_ACCOUNT:
            ...
            $fld7 = $frm->addCheckBox(
                Labels::getLabel("LBL_Activate_Email_Verification_After_Registration", $this->adminLangId), 'CONF_EMAIL_VERIFICATION_REGISTRATION', 1, array(), false, 0
            );
            ...
            $fld9 = $frm->addCheckBox(
                Labels::getLabel("LBL_Activate_Auto_Login_After_Registration", $this->adminLangId), 'CONF_AUTO_LOGIN_REGISTRATION',
                1, array(), false, 0
            );
            ...
            $fld11 = $frm->addCheckBox(
                Labels::getLabel("LBL_Activate_Separate_Seller_Sign_Up_Form", $this->adminLangId), 'CONF_ACTIVATE_SEPARATE_SIGNUP_FORM',
                1, array(), false, 0
            );
            ...
            $fld11 = $frm->addCheckBox(
                Labels::getLabel("LBL_Buyers_can_see_Seller_Tab", $this->adminLangId), 'CONF_BUYER_CAN_SEE_SELLER_TAB', 1,
                array(), false, 0
            );
            ...
            $fld11 = $frm->addCheckBox(
                Labels::getLabel("LBL_Enable_facebook_Login", $this->adminLangId), 'CONF_ENABLE_FACEBOOK_LOGIN', 1,
                array(), false, 0
            );
            ...
            $fld11 = $frm->addCheckBox(
                Labels::getLabel("LBL_Google_Plus_Login", $this->adminLangId), 'CONF_ENABLE_GOOGLE_LOGIN', 1,
                array(), false, 0
            );
        ...
        case Configurations::FORM_CHECKOUT_PROCESS:
            ...
            $fld =$frm->addSelectBox(
                Labels::getLabel("LBL_Default_Child_Order_Status", $this->adminLangId), 'CONF_DEFAULT_ORDER_STATUS',
                $orderStatusArr, false, array(), ''
            );

            $fld =$frm->addSelectBox(
                Labels::getLabel("LBL_Default_Paid_Order_Status", $this->adminLangId), 'CONF_DEFAULT_PAID_ORDER_STATUS',
                $orderStatusArr, false, array(), ''
            );
            ...
            $fld =$frm->addSelectBox(
                Labels::getLabel("LBL_Default_Shipping_Order_Status", $this->adminLangId), 'CONF_DEFAULT_SHIPPING_ORDER_STATUS',
                $orderStatusArr, false, array(), ''
            );
            ...
            $fld =$frm->addSelectBox(
                Labels::getLabel("LBL_Default_Delivered_Order_Status", $this->adminLangId), 'CONF_DEFAULT_DEIVERED_ORDER_STATUS',
                $orderStatusArr, false, array(), ''
            );
            ...
            $fld =$frm->addSelectBox(
                Labels::getLabel("LBL_Default_Cancelled_Order_Status", $this->adminLangId), 'CONF_DEFAULT_CANCEL_ORDER_STATUS',
                $orderStatusArr, false, array(), ''
            );
            ...
            $fld =$frm->addSelectBox(
                Labels::getLabel("LBL_Return_Requested_Order_Status", $this->adminLangId), 'CONF_RETURN_REQUEST_ORDER_STATUS',
                $orderStatusArr, false, array(), ''
            );
        ...
        case Configurations::FORM_AFFILIATE:
            ...
            $fld =$frm->addRadioButtons(
                Labels::getLabel("LBL_Requires_Approval", $this->adminLangId), 'CONF_AFFILIATES_REQUIRES_APPROVAL',
            ...
            $fld =$frm->addRadioButtons(
                Labels::getLabel("LBL_New_Affiliate_Alert_Mail", $this->adminLangId), 'CONF_NOTIFY_ADMIN_AFFILIATE_REGISTRATION',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
            ...
            $fld = $frm->addCheckBox(
                Labels::getLabel("LBL_Activate_Email_Verification_After_Registration", $this->adminLangId), 'CONF_EMAIL_VERIFICATION_AFFILIATE_REGISTRATION', 1, array(), false, 0
            );
        ...
        case Configurations::FORM_REWARD_POINTS:
            ...
            $fld11 = $frm->addCheckBox(
                Labels::getLabel("LBL_Activate_reward_point_on_every_purchase", $this->adminLangId), 'CONF_ENABLE_REWARDS_ON_PURCHASE',
                1, array(), false, 0
            );
            ...
            $frm->addRadioButtons(
                Labels::getLabel("LBL_Enable_birthday_discount", $this->adminLangId), 'CONF_ENABLE_BIRTHDAY_DISCOUNT_REWARDS',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
            ...
            $fld = $frm->addRadioButtons(
                Labels::getLabel("LBL_Enable_Module", $this->adminLangId), 'CONF_ENABLE_BUYING_IN_AN_YEAR_REWARDS',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
        ...
        case Configurations::FORM_REVIEWS:
            ...
            $fld =$frm->addSelectBox(
                Labels::getLabel("LBL_Default_Review_Status", $this->adminLangId), 'CONF_DEFAULT_REVIEW_STATUS',
        ...
        case Configurations::FORM_LIVE_CHAT:
            $fld = $frm->addRadioButtons(
                Labels::getLabel("LBL_Activate_Live_Chat", $this->adminLangId), 'CONF_ENABLE_LIVECHAT',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
        ...
        case Configurations::FORM_REFERAL:
            $fld = $frm->addRadioButtons(
                Labels::getLabel("LBL_Enable_Referral_Module", $this->adminLangId), 'CONF_ENABLE_REFERRER_MODULE',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
        ...
        case Configurations::FORM_DISCOUNT:
            ...
            $frm->addRadioButtons(
                Labels::getLabel("LBL_Enable_1st_time_buyers_discount", $this->adminLangId), 'CONF_ENABLE_FIRST_TIME_BUYER_DISCOUNT',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
        ...
        case Configurations::FORM_SUBSCRIPTION:
            ...
            $enable_subscption_module_fld = $frm->addRadioButtons(
                Labels::getLabel('LBL_Enable_Subscription_Module', $this->adminLangId), 'CONF_ENABLE_SELLER_SUBSCRIPTION_MODULE',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
            ...
            $enable_subscption_module_fld = $frm->addRadioButtons(
                Labels::getLabel('LBL_ENABLE_ADJUST_AMOUNT', $this->adminLangId), 'CONF_ENABLE_ADJUST_AMOUNT_CHANGE_PLAN',
                applicationConstants::getYesNoArr($this->adminLangId), '', array('class'=>'list-inline')
            );
