...
class SellerOrdersController extends AdminBaseController {
	...
	public function updateShippingCompany(){
		...
		$srch->addMultipleFields( array( 'order_id', 'order_pmethod_id', 'order_date_added', 'op_id', 'op_qty', 'op_unit_price',
