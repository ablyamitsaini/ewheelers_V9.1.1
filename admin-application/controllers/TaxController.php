...
class TaxController extends AdminBaseController {
	...
	public function search(){
		...
		$srch->joinTable(Tax::DB_TBL_VALUES, 'LEFT OUTER JOIN',
		'tv.taxval_taxcat_id = t.taxcat_id AND taxval_seller_user_id = 0','tv');
	...
	private function getForm($taxcat_id = 0){
		...
		$frm->addFloatField(Labels::getLabel('LBL_Value',$this->adminLangId),'taxval_value');
