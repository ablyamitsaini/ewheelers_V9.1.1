...
class CatalogReportController extends AdminBaseController {
	...
	public function search( $type = false ){
		...
		$opSrch->addMultipleFields(array( 'SUBSTRING( op_selprod_code, 1, (LOCATE( "_", op_selprod_code ) - 1 ) ) as op_product_id', 'COUNT(op_order_id) as totOrders', 'SUM(op_qty - op_refund_qty) as totSoldQty', 
