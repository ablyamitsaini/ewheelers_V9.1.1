...
class TestimonialsController extends AdminBaseController
{
    ...
    public function getMediaForm( $testimonialId )
    {
        ...
        $frm->addButton(
            Labels::getLabel('Lbl_Image', $this->adminLangId), 'testimonial_image', Labels::getLabel('LBL_Upload_Image', $this->adminLangId),
    ...
    public function uploadTestimonialMedia()
    {
        ...
        if(!$res = $fileHandlerObj->saveImage(
            $_FILES['file']['tmp_name'], $fileHandlerObj::FILETYPE_TESTIMONIAL_IMAGE, 
