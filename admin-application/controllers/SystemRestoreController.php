...
class SystemRestoreController extends AdminBaseController {
    ...
    protected function getRestorePointForm()
    {
        ...
        $frm->addHtml('', 'auto_restore', '<div class="field-set"><div class="caption-wraper"><label class="field_label"><strong>Auto Restore</strong></label></div><div class="field-wraper"><div class="field_cover"><label class="statustab '.$active.'" onclick="toggleStatus(event,this)" id="'.$status.'">
