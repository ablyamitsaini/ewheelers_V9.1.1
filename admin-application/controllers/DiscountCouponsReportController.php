...
class DiscountCouponsReportController extends AdminBaseController
{
    ...
    public function search($type =  false)
    {
        ...
        if($type == 'export') {
            ...
            CommonHelper::convertToCsv($sheetData, str_replace("{reportgenerationdate}", date("d-M-Y"), Labels::getLabel("LBL_Discount_Coupons_Report_{reportgenerationdate}", $this->adminLangId)).'.csv', ','); exit;    
