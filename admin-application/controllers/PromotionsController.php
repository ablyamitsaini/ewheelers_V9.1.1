...
class PromotionsController extends AdminBaseController {
	...
	public function promotionUpload(){
		...
		if(!$res = $fileHandlerObj->saveAttachment($_FILES['file']['tmp_name'],$attachedFileType, $recordId, 0,
