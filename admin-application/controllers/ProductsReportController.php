...
class ProductsReportController extends AdminBaseController {
	...
	public function search( $type = false ){
		...
		$opSrch->addMultipleFields(array('op_selprod_id', 'COUNT(op_order_id) as totOrders', 'SUM(op_qty - op_refund_qty) as totSoldQty', 
		...
		if( $type == 'export' ){
			...
			CommonHelper::convertToCsv($sheetData, 'Products_Report_'.date("d-M-Y").'.csv', ','); exit;	
		} else {
