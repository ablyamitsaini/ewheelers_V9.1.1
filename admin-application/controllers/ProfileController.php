...
class ProfileController extends AdminBaseController{
	...
	public function uploadProfileImage(){
		...
		if($post['action'] == "demo_avatar"){
			...
			$this->set('file',CommonHelper::generateFullUrl('Image','profileImage',array($this->_adminId)).'?'.time());		
		}
		...
		if($post['action'] == "avatar"){
			...
			$this->set('file',CommonHelper::generateFullUrl('Account','userProfileImage',array($this->_adminId,'croped',true)).'?'.time());		
		}	
